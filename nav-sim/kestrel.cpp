...
int main(int argc, char** argv) {
    ...
    if (cmd == "--help" || cmd == "-h" || cmd == "help") {
        std::printf(
            ...
            "                    simulated world, the map it knows, and the camera\n"
            "                    row -- live depth, its voxel map, and people with a\n"
            "                    range each -- from --live, --replay, or the\n"
            "                    simulated D435i. --model: the research window.\n"
